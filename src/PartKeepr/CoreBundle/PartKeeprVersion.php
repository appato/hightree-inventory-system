...
class PartKeeprVersion
{
     ...
     *
     * If 1.4.0, then the function will return 'GIT Development Version'.
     * 1.4.0 will be replaced by the build script with the actual version.
     *
     * The reason why we have a separate class for the version constant is that
     * we can easily replace it from scripts.
     */
    const PARTKEEPR_VERSION = '1.4.0';
}
